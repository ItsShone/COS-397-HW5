...
Brody Looney             brody.looney@maine.edu
Andy Howe                andy.e.howe@maine.edu
Dylan Haughton           dylan.haughton@maine.edu
Sean Staton              sean.staton@maine.edu
Johnny Driscoll          johnny.driscoll@maine.edu


# Description

This project was made to demonstrate DevOps and CI/CD pipeline development techniques. The
program itself enduring the testing, and populating this repository, is a relatively simple
Python program containing bubble, quick, and insertion sorts. 

The added yml file effectively limits maximal filesize, runs the linters - of which we are
using 'Black' and 'Flake8', and detects / registers AWS private keys. The workflow of the 
repository adequately tests the program and package for Windows, OSX, and Linux/Unix, on
both Python 3.9 and 3.10.
